...
from abides.message.Message import Message
from abides.util.OrderBook import OrderBook
...
class ExchangeAgent(FinancialAgent):
  ...
  def __init__(self, id, name, type, mkt_open, mkt_close, symbols, book_freq='S', wide_book=False, pipeline_delay = 40000,
               computation_delay = 1, stream_history = 50, log_orders = False, random_state = None):
